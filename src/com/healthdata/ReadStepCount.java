...
// Main class to read and process Step Count data
public class ReadStepCount {

    // Method to process files and perform the RML mapping for each
    public void processFiles() throws IOException {
        String dataFolder = "schema\\Step Count\\"; // Path to the JSON scemas and tamplate rml file
        String templateRmlFileName = dataFolder + "step_count_temp.ttl"; // Name of the RML template file
        ...
        Files.list(Paths.get(dataFolder))
                ...
                .forEach(path -> {
                    try {
                        ...
                        String NewRmlFileName = dataFolder + "step_count_" + number + "_" + username + ".ttl"; // The new .ttl file with RML rules for each json file.
    ...
    void runRMLMapper(String path, String username, String number) throws IOException, InterruptedException {
        String inputFileName = "step_count_" + number + "_" + username + ".ttl";
        String outputFileName = "step_count_" + number + "_" + username + "_output.ttl";
